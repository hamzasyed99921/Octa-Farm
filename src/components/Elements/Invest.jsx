          ...
          <div className="row">
            ...
            <div className="col-md-7 col-12">
              <div className="row">
                <div className="col-md-5 mt-4">
                  <div className="card ">
                    <div className="card-body">
                      <p className="head mb-3 overflow-hidden">Highest Auto <br /> Compounding Pools</p>
                      <span className="one">
                ...
                <div className="col-md-6 offset-lg-1 mt-4" >
                <div className="card" >
                    <div className="card-body">
                      <p className="head mb-3 overflow-hidden">PROJECTED <br /> Total Value Locked (TVL)</p>
                      <span className="one">
                          <span className="symbol">$</span>
                         538.4
